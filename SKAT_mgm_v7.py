...
class DroneController:
    def __init__(self):
        ...
        self.wp_modes = {12: MODE_LETTERS, 17: MODE_ARUCO, 0: MODE_OFF, 10: MODE_MGM}
    ...
    def process_aruco(self):
        ...
        while self.current_mode == MODE_ARUCO:
            ...
            if ids is not None and current_target_id in ids.flatten():
                ...
                #offset_north_m, offset_east_m = self.calculate_offset(tvecs[0])

                # Отладочная информация
                #self.send_ssh_message(f"Маркер {current_target_id} | Высота: {altitude:.2f}m | N: {offset_north_m:.2f} | E: {offset_east_m:.2f}")
