...
class DroneController:
    def __init__(self):
        ...
        self.wp_modes = {3: MODE_LETTERS, 29: MODE_ARUCO, 0: MODE_OFF, 34: MODE_MGM}
            ...
            if self.USE_PICAM:
                ...
                config = self.camera.create_preview_configuration(
                    ...
                    controls={
                        ...
                        "AwbMode": 2,       # Режим "Auto" (0) или конкретный режим освещения
                        ...
                        "Saturation": 0.3,      # 0.0-2.0 (меньше = менее насыщенные цвета)
                        "Sharpness": 0,       # 0.0-16.0 (умеренная резкость)
                    }
                )
    ...
    def process_frame(self, frame):
        ...
        for cnt in contours:
            ...
            if mean_color < 150:  # Средняя яркость внутри контура
                continue
                    ...
                    if altitude > self.min_altitude:
                        if abs(offset_north) < self.pos_tolerance and abs(offset_east) < self.pos_tolerance:
                            ...
                            self.master.mav.command_long_send(
                                self.master.mav.target_system, 
                                self.master.mav.target_component,
                                31000,0,
                                -offset_north,
                                -offset_east,
                                0,
