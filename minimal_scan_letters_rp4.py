...
# 🔹 Функция для уменьшения изображения до 32x32
def resize_to_32x32(image):
    """ Уменьшает изображение до 32x32 пикселей """
    resized = cv2.resize(image, (32, 32))
    return resized

# 🔹 Основной цикл
def scan_and_process():
    """ Сканирует изображения, находит контур, обрезает и уменьшает до 32x32 """
    while True:
        ...
        if square_contour is not None:
            ...
            # Уменьшаем обрезанное изображение до 32x32
            resized_image = resize_to_32x32(aligned_image)
            
            # Выводим обрезанное и уменьшенное изображение на экран
            cv2.imshow("Resized Image (32x32)", resized_image)
